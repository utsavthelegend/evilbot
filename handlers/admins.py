...
async def pause(client: Client, message: Message):
    ...
    await message.reply_text("**êvilẞø†:** ⏸ Paused.")
...
async def resume(client: Client, message: Message):
    ...
    await message.reply_text("**êvilẞø†:** ▶️ Resumed.")
...
async def stop(client: Client, message: Message):
    ...
    await message.reply_text("**êvilẞø†:** ⏹ Stopped.")
...
async def skip(client: Client, message: Message):
    ...
    await message.reply_text("**êvilẞø†:** ⏩ Skipped the current song.")
...
async def admincache(client, message: Message):
    ...
    await message.reply_text("**êvilẞø†:** ❇️ Admin cache refreshed!")
